...
Now, assume that log(flow) on any given day of the year follows a Gaussian distribution. Equivalently, this means that flow follows a _log normal_ distribution, denoted in R as `*lnorm()` (such as `dlnorm()`). Provide estimates of the following quantities of flow (_not_ log(flow)!). Note that you should not have to fit any more models to answer this question.
